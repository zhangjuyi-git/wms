...
public class GoodsInfoServiceImpl extends ServiceImpl<GoodsInfoMapper, GoodsInfo> implements GoodsInfoService {
    ...
    @Override
    public IPage<GoodsInfo> goodsInfo(IPage<GoodsInfo> iPage, GoodsInfoQueryVo goodsInfoQueryVo) {
		IPage<GoodsInfo> data = goodsInfoMapper.goodsInfo(iPage,goodsInfoQueryVo);
		return data;
    }

    @Override
    public void updateStatus(Long id, Integer status) {
		goodsInfoMapper.updateStatus(id, status);
    }
